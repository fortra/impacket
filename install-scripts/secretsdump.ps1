...
$applicationFolder = "C:\Program Files\secretsdump"
...
# Build
pyinstaller --onefile examples\secretsdump.py
...
$application = Join-Path -Path $repositoryFolder -ChildPath "dist\secretsdump.exe"
