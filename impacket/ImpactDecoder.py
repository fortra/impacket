...
class EAPExpandedDecoder(BaseDecoder):
    ...
    def child_key(s,p): return (p.get_vendor_id(), p.get_vendor_type())
...
class EAPRDecoder(BaseDecoder):
    ...
    def child_key(s, p): return p.get_type()
...
class EAPDecoder(BaseDecoder):
    ...
    def child_key(s, p): return p.get_code()
...
class EAPOLDecoder(BaseDecoder):
    ...
    def child_key(s, p): return p.get_packet_type()
