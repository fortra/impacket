...
class Dot11ManagementCapability:
    #
    ...
    #   |-------------------------------------------------------------- ESS
    #
    CAPABILITY_RESERVED_1      = int("0000000000000001", 2)
    CAPABILITY_RESERVED_2      = int("0000000000000010", 2)
    CAPABILITY_DSSS_OFDM       = int("0000000000000100", 2)
    CAPABILITY_RESERVED_3      = int("0000000000001000", 2)
    CAPABILITY_RESERVED_4      = int("0000000000010000", 2)
    CAPABILITY_SHORT_SLOT_TIME = int("0000000000100000", 2)
    CAPABILITY_RESERVED_5      = int("0000000001000000", 2)
    CAPABILITY_RESERVED_6      = int("0000000010000000", 2)
    CAPABILITY_CH_AGILITY      = int("0000000100000000", 2)
    CAPABILITY_PBCC            = int("0000001000000000", 2)
    CAPABILITY_SHORT_PREAMBLE  = int("0000010000000000", 2)
    CAPABILITY_PRIVACY         = int("0000100000000000", 2)
    CAPABILITY_CF_POLL_REQ     = int("0001000000000000", 2)
    CAPABILITY_CF_POLLABLE     = int("0010000000000000", 2)
    CAPABILITY_IBSS            = int("0100000000000000", 2)
    CAPABILITY_ESS             = int("1000000000000000", 2)
