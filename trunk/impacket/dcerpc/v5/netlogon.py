...
class DCERPCNetLogon:
    ...
    def NetrServerReqChallenge(self, primaryName='', computerName='X', clientChallenge='12345678'):
        ...
        reqChallenge['PrimaryName'] = primaryName+'\x00'
        reqChallenge['ComputerName'] = computerName+'\x00'
    ...
    def NetrServerAuthenticate3(self, primaryName, accountName, secureChannelType, computerName='X', clientCredential='', negotiateFlags=''):
        ...
        serverAuthenticate3['PrimaryName'] = primaryName+'\x00'
        serverAuthenticate3['AccountName'] = accountName+'\x00'
        serverAuthenticate3['SecureChannelType'] = secureChannelType
        serverAuthenticate3['ComputerName'] = computerName+'\x00'
    ...
    def DsrGetDcSiteCoverageW(self, serverName=''):
        ...
        getDCSite['ServerName'] = serverName+'\x00'
    ...
    def DsrGetSiteName(self, computerName=''):
        ...
        getSiteName['ComputerName'] = computerName+'\x00'
    ...
    def DsrNetrGetAnyDCName(self, serverName='', domainName=''):
        ...
        getAnyDCName['ServerName'] = serverName+'\x00'
        getAnyDCName['DomainName'] = domainName+'\x00'
    ...
    def NetrGetDCName(self, serverName='', domainName=''):
        ...
        getDCName['ServerName'] = serverName+'\x00'
        getDCName['DomainName'] = domainName+'\x00'
    ...
    def NetrServerGetTrustInfo(self, trustedDcName, accountName, secureChannelType, computerName='X', authenticator=None):
        ...
        getTrustInfo['TrustedDcName'] = trustedDcName+'\x00'
        getTrustInfo['AccountName'] = accountName+'\x00'
        getTrustInfo['SecureChannelType'] = secureChannelType
        getTrustInfo['ComputerName'] = computerName+'\x00'

        getTrustInfo['Authenticator']['Timestamp'] = authenticator['Timestamp']
        getTrustInfo['Authenticator']['Credential'] = authenticator['Credential']
    ...
    def NetrServerPasswordGet(self, primaryName, accountName, accountType, computerName='X', authenticator=None):
        ...
        passwordGet['PrimaryName'] = primaryName+'\x00'
        passwordGet['AccountName'] = accountName+'\x00'
        passwordGet['AccountType'] = accountType
        passwordGet['ComputerName'] = computerName+'\x00'
    ...
    def NetrLogonGetDomainInfo(self, serverName, computerName='X', authenticator=None):
        ...
        getDomainInfo['ServerName'] = serverName+'\x00'
        getDomainInfo['ComputerName'] = computerName+'\x00'
    ...
    def NetrLogonGetCapabilities(self, serverName, computerName='X', authenticator = None):
        ...
        getCapabilities['ServerName'] = serverName+'\x00'
        getCapabilities['ComputerName'] = computerName+'\x00'
        getCapabilities['Authenticator'] = authenticator
        getCapabilities['ReturnAuthenticator'] = NETLOGON_AUTHENTICATOR()
        getCapabilities['Level'] = 1
