...
from impacket.dcerpc.ndr import NDRCall, NDR, NDRPointer, UNIQUE_RPC_UNICODE_STRING, NDRLONG, WSTR, RPC_UNICODE_STRING, NDRPointerNULL, NDRUniConformantArray, PNDRUniConformantArray, NDRBOOLEAN, NDRSHORT, NDRUniFixedArray, NDRUnion, NULL
...
#    def RQueryServiceConfig2W(self, hService, dwInfoLevel, cbBufSize):
#        queryServiceConfig2 = RQueryServiceConfig2WCall()
#        queryServiceConfig2['hService'] = hService
#        queryServiceConfig2['dwInfoLevel'] = dwInfoLevel
#        queryServiceConfig2['cbBufSize'] = cbBufSize
#        ans = self.doRequest(queryServiceConfig2)
#        resp = RQueryServiceConfig2WResponse(ans)
#        return resp
