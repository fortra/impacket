...
class SHORT_ARRAY(ndr.NDRUniConformantVaryingArray):
    item = '<H'
    pass
...
class CHAR_ARRAY(ndr.NDRUniConformantVaryingArray):
    pass
...
class LOGON_HOURS_ARRAY(ndr.NDRUniConformantVaryingArray):
    pass
