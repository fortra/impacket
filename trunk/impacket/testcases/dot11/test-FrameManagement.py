...
class TestDot11ManagementBeaconFrames(unittest.TestCase):
    ...
    def test_03_Destination_Address(self):
    ...
    def test_04_Source_Address(self):
    ...
    def test_05_BSSID_Address(self):
    ...
    def test_08_secuence_number(self):
        ...
        self.assertEqual(self.management_base.get_secuence_number(), 1915)
        self.management_base.set_secuence_number(0xF234) # Es de 12 bit
    ...
    def test_11_beacon_interval(self):
    ...
    def test_12_beacon_capabilities(self):
