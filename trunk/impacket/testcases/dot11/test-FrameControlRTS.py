...
class TestDot11FrameControlRTS(unittest.TestCase):
    ...
    def test_01_Type(self):
        'Test Type field'
        self.assertEqual(self.rts.get_type(), Dot11.DOT11_TYPE_CONTROL)
        rts=Dot11ControlFrameRTS()
        self.assertEqual(rts.get_type(), Dot11.DOT11_TYPE_CONTROL)

    def test_02_SubType(self):
        'Test SubType field'
        self.assertEqual(self.rts.get_subtype(), Dot11.DOT11_SUBTYPE_CONTROL_REQUEST_TO_SEND)
        rts=Dot11ControlFrameRTS()
        self.assertEqual(rts.get_subtype(), Dot11.DOT11_SUBTYPE_CONTROL_REQUEST_TO_SEND)
    
    def test_03_TypeSubtype(self):
        'Test Type and SubType field'
        self.assertEqual(self.rts.get_type_n_subtype(), Dot11.DOT11_TYPE_CONTROL_SUBTYPE_REQUEST_TO_SEND)
        rts=Dot11ControlFrameRTS()
        self.assertEqual(rts.get_type_n_subtype(), Dot11.DOT11_TYPE_CONTROL_SUBTYPE_REQUEST_TO_SEND)
    ...
    def test_08_FCS(self):
        ...
        fcs=self.rts.get_fcs()
        
        self.assertEqual(fcs, 0x99754373)
        self.rts.set_fcs(0x44332211)
        self.assertEqual(self.rts.get_fcs(), 0x44332211)
