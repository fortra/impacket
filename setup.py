...
setup(name = PACKAGE_NAME,
      ...
      packages = ['impacket', 'impacket.dcerpc', 'impacket.examples', 'impacket.dcerpc.v5', 'impacket.dcerpc.v5.dcom', 'impacket.krb5', 'impacket.ldap', 'impacket.ntlmrelayx', 'impacket.ntlmrelayx.clients', 'impacket.ntlmrelayx.servers', 'impacket.ntlmrelayx.utils'],
