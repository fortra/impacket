...
class TestDot11ManagementProbeResponseFrames(unittest.TestCase):
    ...
    def test_16(self):
        ...
        self.assertEqual(self.management_probe_response.get_vendor_specific(), 
            [(0x0050F2,""),
             (0x0050F2,"\x05\x00"),
			 (0x001018,"\x02\x01\xf0\x00\x00\x00"),
			 (0x0050f2,"\x01\x01\x00\x00\x50\xf2\x02\x01\x00\x00\x50\xf2\x02\x01\x00\x00\x50\xf2\x02\x00\x00"),
            ])
        
        self.management_probe_response.add_vendor_specific(0x40,"\x04\x04\x04\x04\x04\x04")
