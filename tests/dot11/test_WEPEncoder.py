...
class TestDot11WEPData(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.km=KeyManager()
        self.km.add_key([0x00,0x21,0x29,0x68,0x33,0x5b], codecs.decode(b'999cbb701ca2ef030e302dcc35','hex_codec'))
    ...
    def test_03(self):
        ...
        self.wepdata.set_icv(0xA1F93985)
        wep_enc=self.wep.get_encrypted_data(codecs.decode(b'999cbb701ca2ef030e302dcc35','hex_codec'))
        #print "\nWEP Data Encrypted [%s]"%hexlify(wep_enc)
        self.assertEqual(wep_enc, codecs.decode(b'8d2381e9251cb5aa83d2c716ba6ee18e7d3a2c71c00f6ab82fbc54c4b014ab03115edeccab2b18ebeb250f75eb6bf57fd65cb9e1b26e50ba4bb48b9f3471da9ecf12cb8f361b0253','hex_codec'))
        
        #print "\nDot11 decrypted [%s]"%hexlify(self.dot11.get_packet())
        self.wep.encrypt_frame(codecs.decode(b'999cbb701ca2ef030e302dcc35','hex_codec'))
