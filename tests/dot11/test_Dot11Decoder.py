...
class TestDot11Decoder(unittest.TestCase):
    ...
    def test_01_Dot11Decoder(self):
        'Test Dot11 decoder'
        self.assertEqual(str(self.in0.__class__.__module__+"."+self.in0.__class__.__name__), "impacket.dot11.Dot11")
        
    def test_02_Dot11DataFrameDecoder(self):
        'Test Dot11DataFrame decoder'
        self.assertEqual(str(self.in1.__class__.__module__+"."+self.in1.__class__.__name__), "impacket.dot11.Dot11DataFrame")

    def test_03_Dot11WEP(self):
        'Test Dot11WEP decoder'
        self.assertEqual(str(self.in2.__class__.__module__+"."+self.in2.__class__.__name__), "impacket.dot11.Dot11WEP")
