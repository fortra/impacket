...
from impacket.dot11 import Dot11, Dot11Types, Dot11ManagementFrame,Dot11ManagementBeacon
...
class TestDot11ManagementBeaconFrames(unittest.TestCase):
    ...
    def test_16(self):
        ...
        self.assertEqual(self.management_beacon.get_vendor_specific(), [(b"\x00\x50\xf2",b"\x02\x01\x01\x00\x00\x03\xa4\x00\x00\x27\xa4\x00\x00\x42\x43\x5e\x00\x62\x32\x2f\x00")])
