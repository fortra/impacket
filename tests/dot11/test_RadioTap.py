...
class TestRadioTap(unittest.TestCase):
    ...
    def test_04_present_bits(self):
        ...
        self.assertFalse(self.rt0.get_present_bit(RadioTap.RTF_TSFT))
        self.assertTrue(self.rt0.get_present_bit(RadioTap.RTF_FLAGS))
        self.assertTrue(self.rt0.get_present_bit(RadioTap.RTF_RATE))
        self.assertTrue(self.rt0.get_present_bit(RadioTap.RTF_CHANNEL))
        self.assertFalse(self.rt0.get_present_bit(RadioTap.RTF_FHSS))
        self.assertFalse(self.rt0.get_present_bit(RadioTap.RTF_DBM_ANTSIGNAL))
        self.assertFalse(self.rt0.get_present_bit(RadioTap.RTF_DBM_ANTNOISE))
        self.assertFalse(self.rt0.get_present_bit(RadioTap.RTF_LOCK_QUALITY))
        self.assertFalse(self.rt0.get_present_bit(RadioTap.RTF_TX_ATTENUATION))
        self.assertFalse(self.rt0.get_present_bit(RadioTap.RTF_DB_TX_ATTENUATION))
        self.assertFalse(self.rt0.get_present_bit(RadioTap.RTF_DBM_TX_POWER))
        self.assertTrue(self.rt0.get_present_bit(RadioTap.RTF_ANTENNA))
        self.assertTrue(self.rt0.get_present_bit(RadioTap.RTF_DB_ANTSIGNAL))
        self.assertFalse(self.rt0.get_present_bit(RadioTap.RTF_DB_ANTNOISE))
        self.assertTrue(self.rt0.get_present_bit(RadioTap.RTF_FCS_IN_HEADER))
        self.assertFalse(self.rt0.get_present_bit(RadioTap.RTF_TX_FLAGS))
        self.assertFalse(self.rt0.get_present_bit(RadioTap.RTF_RTS_RETRIES))
        self.assertFalse(self.rt0.get_present_bit(RadioTap.RTF_DATA_RETRIES))
        self.assertFalse(self.rt0.get_present_bit(RadioTap.RTF_XCHANNEL))
        self.assertFalse(self.rt0.get_present_bit(RadioTap.RTF_EXT))

        self.assertTrue(self.rt1.get_present_bit(RadioTap.RTF_TSFT))
        self.assertTrue(self.rt1.get_present_bit(RadioTap.RTF_FLAGS))
        self.assertTrue(self.rt1.get_present_bit(RadioTap.RTF_RATE))
        self.assertFalse(self.rt1.get_present_bit(RadioTap.RTF_CHANNEL))
        self.assertFalse(self.rt1.get_present_bit(RadioTap.RTF_FHSS))
        self.assertTrue(self.rt1.get_present_bit(RadioTap.RTF_DBM_ANTSIGNAL))
        self.assertTrue(self.rt1.get_present_bit(RadioTap.RTF_DBM_ANTNOISE))
        self.assertFalse(self.rt1.get_present_bit(RadioTap.RTF_LOCK_QUALITY))
        self.assertFalse(self.rt1.get_present_bit(RadioTap.RTF_TX_ATTENUATION))
        self.assertFalse(self.rt1.get_present_bit(RadioTap.RTF_DB_TX_ATTENUATION))
        self.assertFalse(self.rt1.get_present_bit(RadioTap.RTF_DBM_TX_POWER))
        self.assertTrue(self.rt1.get_present_bit(RadioTap.RTF_ANTENNA))
        self.assertFalse(self.rt1.get_present_bit(RadioTap.RTF_DB_ANTSIGNAL))
        self.assertFalse(self.rt1.get_present_bit(RadioTap.RTF_DB_ANTNOISE))
        self.assertFalse(self.rt1.get_present_bit(RadioTap.RTF_FCS_IN_HEADER))
        self.assertFalse(self.rt1.get_present_bit(RadioTap.RTF_TX_FLAGS))
        self.assertFalse(self.rt1.get_present_bit(RadioTap.RTF_RTS_RETRIES))
        self.assertFalse(self.rt1.get_present_bit(RadioTap.RTF_DATA_RETRIES))
        self.assertTrue(self.rt1.get_present_bit(RadioTap.RTF_XCHANNEL))
        self.assertFalse(self.rt1.get_present_bit(RadioTap.RTF_EXT))

    def test_05_tsft(self):
        """Test RadioTap tstf getter"""
        self.assertIsNone(self.rt0.get_tsft())
    ...
    def test_07_unset_fields(self):
        ...
        self.assertFalse(self.rt0.get_present_bit(RadioTap.RTF_FLAGS))
        ...
        self.assertFalse(self.rt1.get_present_bit(RadioTap.RTF_TSFT))
    ...
    def test_10_channel_field(self):
        ...
        self.assertEqual(self.rt1.get_size(), len(self.frame_1))
        self.assertEqual(self.rt1.get_header_size(), 32)
        self.assertIsNone(self.rt1.get_channel())
    ...
    def test_11_fhss_field(self):
        ...
        self.assertEqual(self.rt1.get_size(), len(self.frame_1))
        self.assertEqual(self.rt1.get_header_size(), 32)
        self.assertIsNone(self.rt1.get_FHSS())
    ...
    def test_12_dbm_ant_signal_field(self):
        ...
        self.assertEqual(self.rt0.get_size(), len(self.frame_0))
        self.assertEqual(self.rt0.get_header_size(), 24)
        self.assertIsNone(self.rt0.get_dBm_ant_signal())
    ...
    def test_13_dbm_ant_noise_field(self):
        ...
        self.assertEqual(self.rt0.get_size(), len(self.frame_0))
        self.assertEqual(self.rt0.get_header_size(), 24)
        self.assertIsNone(self.rt0.get_dBm_ant_noise())
    ...
    def test_14_lock_quality_field(self):
        ...
        self.assertEqual(self.rt1.get_size(), len(self.frame_1))
        self.assertEqual(self.rt1.get_header_size(), 32)
        self.assertIsNone(self.rt1.get_lock_quality())
    ...
    def test_15_tx_attenuation_field(self):
        ...
        self.assertEqual(self.rt1.get_size(), len(self.frame_1))
        self.assertEqual(self.rt1.get_header_size(), 32)
        self.assertIsNone(self.rt1.get_tx_attenuation())
    ...
    def test_16_dB_tx_attenuation_field(self):
        ...
        self.assertEqual(self.rt1.get_size(), len(self.frame_1))
        self.assertEqual(self.rt1.get_header_size(), 32)
        self.assertIsNone(self.rt1.get_dB_tx_attenuation())
    ...
    def test_17_dbm_tx_power_field(self):
        ...
        self.assertEqual(self.rt1.get_size(), len(self.frame_1))
        self.assertEqual(self.rt1.get_header_size(), 32)
        self.assertIsNone(self.rt1.get_dBm_tx_power())
    ...
    def test_19_db_ant_signal_field(self):
        ...
        self.assertEqual(self.rt1.get_size(), len(self.frame_1))
        self.assertEqual(self.rt1.get_header_size(), 32)
        self.assertIsNone(self.rt1.get_dB_ant_signal())
    ...
    def test_20_db_ant_noise_field(self):
        ...
        self.assertEqual(self.rt1.get_size(), len(self.frame_1))
        self.assertEqual(self.rt1.get_header_size(), 32)
        self.assertIsNone(self.rt1.get_dB_ant_noise())
        ...
        self.assertEqual(self.rt0.get_size(), len(self.frame_0))
        self.assertEqual(self.rt0.get_header_size(), 24)
        self.assertIsNone(self.rt0.get_dB_ant_noise())
    ...
    def test_22_fcs_in_header_field(self):
        ...
        self.assertEqual(self.rt1.get_size(), len(self.frame_1))
        self.assertEqual(self.rt1.get_header_size(), 32)
        self.assertIsNone(self.rt1.get_FCS_in_header())
    ...
    def test_24_rts_retries_field(self):
        ...
        self.assertEqual(self.rt1.get_size(), len(self.frame_1))
        self.assertEqual(self.rt1.get_header_size(), 32)
        self.assertIsNone(self.rt1.get_RTS_retries())
    ...
    def test_25_tx_flags_field(self):
        ...
        self.assertEqual(self.rt1.get_size(), len(self.frame_1))
        self.assertEqual(self.rt1.get_header_size(), 32)
        self.assertIsNone(self.rt1.get_tx_flags())
    ...
    def test_27_data_retries_field(self):
        ...
        self.assertEqual(self.rt1.get_size(), len(self.frame_1))
        self.assertEqual(self.rt1.get_header_size(), 32)
        self.assertIsNone(self.rt1.get_data_retries())
    ...
    def test_31_radiotap_present_flags_extended(self):
        ...
        self.assertTrue(self.rt2.get_present_bit(RadioTap.RTF_EXT))
        self.assertTrue(self.rt2.get_present_bit(RadioTap.RTF_RATE))
        self.assertTrue(self.rt2.get_present_bit(RadioTap.RTF_CHANNEL))
        ...
        self.assertTrue(self.rt3.get_present_bit(RadioTap.RTF_EXT))
        self.assertTrue(self.rt3.get_present_bit(RadioTap.RTF_RATE))
        self.assertTrue(self.rt3.get_present_bit(RadioTap.RTF_CHANNEL))
