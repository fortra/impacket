...
class TestDot11ManagementAssociationRequestFrames(unittest.TestCase):
    ...
    def test_13(self):
        ...
        self.assertEqual(self.management_association_request.get_supported_rates(),
                         (0x82, 0x84, 0x8b, 0x96, 0x24, 0x30, 0x48, 0x6c))
        self.assertEqual(self.management_association_request.get_supported_rates(human_readable=True),
    ...
    def test_14(self):
        ...
        self.assertEqual(self.management_association_request.get_rsn(),
                         b"\x01\x00\x00\x0f\xac\x04\x01\x00\x00\x0f\xac\x04\x01\x00\x00\x0f\xac\x02\x08\x00")

        self.management_association_request.set_rsn(
