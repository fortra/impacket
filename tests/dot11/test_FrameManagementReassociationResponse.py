...
class TestDot11ManagementReassociationResponseFrames(unittest.TestCase):
    ...
    def test_setups(self):
        ...
        if PY2:
            ...
            self.assertEqual(str(self.management_reassociation_response.__class__),
        ...
        self.assertEqual(self.dot11.get_subtype(), Dot11Types.DOT11_SUBTYPE_MANAGEMENT_REASSOCIATION_RESPONSE)
        self.assertEqual(self.dot11.get_type_n_subtype(), Dot11Types.DOT11_TYPE_MANAGEMENT_SUBTYPE_REASSOCIATION_RESPONSE)
