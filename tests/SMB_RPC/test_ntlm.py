...
class NTLMTests(unittest.TestCase):
    ...
    def test_ntlmv1(self):
        ...
        ntResponse, lmResponse, sessionBaseKey  = ntlm.computeResponseNTLMv1(long(self.flags), self.serverChallenge,
        ...
        ntResponse, lmResponse, sessionBaseKey  = ntlm.computeResponseNTLMv1(long(flags2), self.serverChallenge,
        ...
        ntResponse, lmResponse, sessionBaseKey  = ntlm.computeResponseNTLMv1(long(flags), self.serverChallenge, self.clientChallenge,
    ...
    def test_ntlmv2(self):
        ...
        print "\n"
        res = ntlm.LMOWFv2(self.user,self.password,self.domain)
        hexdump(res)
        self.assertTrue(res==bytearray(b'\x0c\x86\x8a@;\xfdz\x93\xa3\x00\x1e\xf2.\xf0.?'))
        print "\n"
        ...
        hexdump(sessionBaseKey)
        self.assertTrue(sessionBaseKey==bytearray(b'\x9a`X.oT\x06\xe6Om\xf9\xa2\xdd\xb4\x0e_'))
        print "\n"
        ...
        hexdump(ntResponse)
        self.assertTrue(ntResponse==bytearray(b'\xf9\xcdO\xdf\xc3\x01\xce\x0c\x02G\xf7\xca\xa0\xfa\x90\xd9\x01\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\x00\x00\x00\x00\x01\x00\x0c\x00S\x00e\x00r\x00v\x00e\x00r\x00\x02\x00\x0c\x00D\x00o\x00m\x00a\x00i\x00n\x00\x07\x00\x08\x00\x00\x00\x00\x00\x00\x00\x00\x00\t\x00\x16\x00c\x00i\x00f\x00s\x00/\x00S\x00e\x00r\x00v\x00e\x00r\x00\x00\x00\x00\x00\x00\x00\x00\x00'))
        print "\n"
        print "4.2.4.2.3 Encrypted Session Key"
        keyExchangeKey = ntlm.KXKEY(flags, sessionBaseKey, lmResponse, self.serverChallenge, self.password,'','')
        encryptedSessionKey = ntlm.generateEncryptedSessionKey(keyExchangeKey,self.randomSessionKey)
        hexdump(encryptedSessionKey)
        self.assertTrue(encryptedSessionKey==bytearray(b'\x08\xde\xd9\x99 n\xf1\xa8\xb7\xd0\x9b\xca\xcc\xaaW\xaa'))
        print "\n"
        ...
        ntlmChallengeResponse['session_key'] = encryptedSessionKey
        hexdump(str(ntlmChallengeResponse))
        self.assertTrue(ntlmChallengeResponse.getData()==bytearray(b'NTLMSSP\x00\x03\x00\x00\x00\x18\x00\x18\x00|\x00\x00\x00z\x00z\x00\x94\x00\x00\x00\x0c\x00\x0c\x00X\x00\x00\x00\x08\x00\x08\x00d\x00\x00\x00\x10\x00\x10\x00l\x00\x00\x00\x10\x00\x10\x00\x0e\x01\x00\x003\x82\x8a\xe2D\x00o\x00m\x00a\x00i\x00n\x00U\x00s\x00e\x00r\x00C\x00O\x00M\x00P\x00U\x00T\x00E\x00R\x00\x86\xc3P\x97\xac\x9c\xec\x10%TvJW\xcc\xcc\x19\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xf9\xcdO\xdf\xc3\x01\xce\x0c\x02G\xf7\xca\xa0\xfa\x90\xd9\x01\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\x00\x00\x00\x00\x01\x00\x0c\x00S\x00e\x00r\x00v\x00e\x00r\x00\x02\x00\x0c\x00D\x00o\x00m\x00a\x00i\x00n\x00\x07\x00\x08\x00\x00\x00\x00\x00\x00\x00\x00\x00\t\x00\x16\x00c\x00i\x00f\x00s\x00/\x00S\x00e\x00r\x00v\x00e\x00r\x00\x00\x00\x00\x00\x00\x00\x00\x00\x08\xde\xd9\x99 n\xf1\xa8\xb7\xd0\x9b\xca\xcc\xaaW\xaa'))
        print "\n"
