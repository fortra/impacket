...
def start_servers(options, threads):
    for server in RELAY_SERVERS:
        ...
        c.setLDAPOptions(options.no_dump, options.no_da, options.no_acl, options.no_validate_privs, options.escalate_user, options.add_user, options.add_computer, options.delegate_access, options.dump_laps, options.dump_gmsa, options.dump_adcs, options.sid)
...
if __name__ == '__main__':
    ...
    ldapoptions.add_argument('--add-user', action='store', metavar=('USERNAME', 'PASSWORD'), required=False, nargs='*', help='Attempt to add a new user account')
